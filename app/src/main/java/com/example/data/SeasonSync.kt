...
object SeasonSync {
    ...
    private const val DATA_URL =
        "https://github.com/inspectorgad/markdown/releases/latest/download/season-data.json"
    ...
    suspend fun sync(context: Context, dao: DiamondsDao): SyncResult =
